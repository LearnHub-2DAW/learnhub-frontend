...
export const enrollModulo = (id, clave_matricula) => api.post(`/modulos/${id}/enroll`, clave_matricula ? { clave_matricula } : {});
...
export const getModuloClave = (id) => api.get(`/modulos/${id}/clave`);
export const regenerarClave = (id) => api.put(`/modulos/${id}/clave`, {});
...
export const getEventosByModulo = (id) => api.get(`/modulos/${id}/eventos`);
